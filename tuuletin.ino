// Tuulettimen webbiserveri. Toimii 12 tuntia.
...
const long interval = 12*3600*1000; // 12 tuntia
    ...
    while (client.connected()) {            // loop while the client's connected
      if (client.available()) {             // if there's bytes to read from the client,
	    ...
	    client.println(WiFi.softAPIP());
	      ...
	      client.println(12*3600-(currentMillis - previousMillis)/60000); // Jäljellä olevat minuutit
            } 
